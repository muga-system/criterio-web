...
- Smoke E2E responsive para proteger la shell fija y el scroll interno en viewport angosto.
...
- Comando `npm run verify` para ejecutar el gate completo junto con la guía de prueba manual de la
  primera versión.
...
- El catálogo informa si la práctica de cada módulo se realiza fuera de la app o dentro de la
  interacción local.
